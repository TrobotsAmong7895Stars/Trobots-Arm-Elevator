...
public class RobotContainer {
  ...
  public RobotContainer() {
    ...
    elevatorSubsytem.setDefaultCommand(elevatorSubsytem.set(0));
  ...
  private void configureBindings() {
    ...
    m_driverController.x().whileTrue(elevatorSubsytem.setHeight(Meters.of(0.5)));
    m_driverController.y().whileTrue(elevatorSubsytem.setHeight(Meters.of(1)));
